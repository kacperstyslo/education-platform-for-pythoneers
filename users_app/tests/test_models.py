...
class TestUsersTasksSolutions(TestCase):
    ...
    def test_users_tasks_solutions_instance(self):
        """
    ...
    def test_get_users_tasks_solutions_id(self):
        self.assertEqual(self.test_users_tasks_solutions.id, 1, msg="Should be 1")

    def test_users_tasks_solutions_task_title_content(self):
    ...
    def test_users_tasks_solutions_user_nickname_content(self):
    ...
    def test_users_tasks_solutions_user_solution_content(self):
    ...
    def test_default_value_of_field_user_amounts_of_try(self):
        self.assertEqual(
            self.test_users_tasks_solutions.user_amounts_of_try, 1, msg="By default " "should be 1"
        )

    def test_default_value_of_field_amount_tests_cases_passed(self):
        self.assertEqual(
    ...
    def test_default_value_of_field_is_task_passed(self):
        self.assertFalse(
