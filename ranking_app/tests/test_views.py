...
class TestRankingView(TestCase):
    ...
    def test_if_ranking_view_render_on_indicated_url(self):
    ...
    def test_name_of_rendered_template_to_ranking_view(self):
        """
    ...
    def test_anonymous_user_get_on_ranking_page(self):
        self.assertEqual(
