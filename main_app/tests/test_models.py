...
class TestTasksTable(TestCase):
    ...
    def test_task_description_content(self):
    ...
    def test_task_starter_content(self):
    ...
    def test_default_amount_of_tests_cases(self):
        self.assertEqual(self.test_task.amount_tests_cases, 1, msg="By default should be 1")

    def test_default_content_of_task_tests(self):
