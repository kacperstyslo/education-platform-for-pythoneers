...
class TestTasksStatistics(TestCase):
    ...
    def test_task_statistics_instance(self):
        """
    ...
    def test_get_task_statistics_id(self):
        self.assertEqual(self.test_task_statistics.id, 1, msg="Should be 1")

    def test_task_statistics_title_content(self):
    ...
    def test_default_amount_of_sum_of_all_tries_per_task(self):
        self.assertEqual(
            self.test_task_statistics.sum_of_all_tries_per_task, 0, msg="By default " "should be 0"
        )

    def test_default_amount_of_sum_of_all_successful_submission_per_task(self):
        self.assertEqual(
